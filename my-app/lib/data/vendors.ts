...
const seeds: VendorSeed[] = [
  ...
  { businessName: "Raga Live Band", ownerName: "Suresh Bhat", categorySlug: "bands", citySlug: "mumbai", area: "Juhu", tagline: "Fusion live band for weddings and corporate events", startingPrice: 60000, rating: 4.6, reviewCount: 71, verified: true, portfolioSet: "entertainment", services: ["Live Band Performance", "Fusion Sets", "Sangeet Performances"], eventTypes: [...WEDDING_EVENTS, ...CORPORATE_EVENTS], yearsInBusiness: 10, responseTime: "Under 6 hours", packageUnit: "live performance" },
  ...
  { businessName: "Magic Moments — Karthik", ownerName: "Karthik Subramaniam", categorySlug: "magicians", citySlug: "coimbatore", area: "RS Puram", tagline: "Interactive magic shows for kids and adults", startingPrice: 12000, rating: 4.6, reviewCount: 64, verified: false, portfolioSet: "entertainment", services: ["Stage Magic", "Close-up Magic", "Kids Shows"], eventTypes: ["birthdays", "family-functions"], yearsInBusiness: 5, responseTime: "Under 5 hours", packageUnit: "magic show" },
